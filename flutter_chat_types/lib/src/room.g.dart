...
/* 
  var lastMessage = instance.lastMessage;
  try {
    lastMessage![instance.users.first.id] =
        lastMessage[instance.users.first.id]?.millisecondsSinceEpoch;
  } catch (e) {
    print("room.g.dart $e");
  }
  try {
    lastMessage![instance.users.last.id] =
        lastMessage[instance.users.last.id]?.millisecondsSinceEpoch;
  } catch (e) {
    print("room.g.dart $e");
  } */

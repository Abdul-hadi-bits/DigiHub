...
import 'input/editInput.dart' as editInput;
...
class Chat extends StatefulWidget {
  ...
  final types.Message? messageEdit;
  ...
  final void Function(BuildContext context, types.Message, GlobalKey key)?
      onMessageLongPress;
  ...
  /// Update message.
  final void Function(types.PartialText) onUpdatePressed;
                    ...
                    children: [
                      ...
                      !widget.isEditMode
                          ...
                          : editInput.EditInput(
                              ...
                              editMessage: widget.messageEdit,
                              onSendPressed: widget.onUpdatePressed,
                            ),
                    ],
                  ),
                ),

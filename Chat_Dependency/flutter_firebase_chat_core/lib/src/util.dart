    ...
    if (data['lastMessage'] != null) {
      try {
        data['lastMessage']['createdAt'] =
            data['lastMessage']['createdAt']?.millisecondsSinceEpoch;
        data['lastMessage']['updatedAt'] =
            data['lastMessage']['updatedAt']?.millisecondsSinceEpoch;
      } catch (e) {
        print('3');
      }

      data['lastMessage']['id'] = data['lastMessage']['id'] ?? '';
    }

    return types.Room.fromJson(data);
  } catch (e) {
    print(e);
    print('inside utils .dart');
    return types.Room.fromJson(data);
  }
}

...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.codesfirst.safetynet_attestation.SafetynetAttestationPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin safetynet_attestation, com.codesfirst.safetynet_attestation.SafetynetAttestationPlugin", e);
    }
    try {
